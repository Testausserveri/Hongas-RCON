...
<html>
	<head>
		...
		<style>
			input { font-family: 'Fira Code', monospace;font-size:110%; color:white;border: none;width: 100%; height: 30px; background: rgba(0,0,0,0.7); }
			body > div { background: url(http://guide2games.org/wp-content/uploads/2008/02/cs-source2.jpg); font-family: 'Fira Code', monospace;color:white; padding: 0px; width: 800px; margin:10% auto; overflow: hidden;}
